...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Purchased Inventories</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5> Purchased Inventories <small></small></h5>
                ...
                <table class="table" id="myTable">
                    ...
                    @if (!empty($items))
                        @forelse ($items as $key => $inv)
							...
							<td>
                                <a href="{{url('purchase_detail/' . $inv->id)}}"><i class="fa fa-eye"></i></a>
                                <a href="{{url('edit_purchase/' . $inv->id)}}"><i class="fa fa-edit"></i></a>
