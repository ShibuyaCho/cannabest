...
//              "Agosto","Septiembre","Octubre","Noviembre","Diciembre");
  ...
  ?>
        ...
        <div class="row">
            <div class="col-lg-1"  style="background:rbga(86, 140, 35 ,0.2);">
                <div class="ibox float-e-margins"  style="background:#489c1c;">
                    <div class="ibox-title"  style="background:#489c1c">
                        <span class="label label-info pull-right">{{$total_sales_today}} {{$total_sales_today}}{{$total_sales_today}}{{$total_sales_today}}{{$total_sales_today}}{{$total_sales_today}}{{$total_sales_today}}{{$total_sales_today}}</span>
                        <h5>@lang('dashboard.today')</h5>
                    </div>
                    <div class="ibox-content"  style="background:#489c1c">
